...
mod ERC721Preset2 {
    ...
    trait IERC721Preset2 {
        fn constructor(name_: felt, symbol_: felt, max_supply: u128, max_date: u64, whitelited_collection_:ContractAddress);
        fn mint(to: ContractAddress, token_id: u256);
    }

    impl ERC721Preset2Impl of IERC721Preset2 {
        #[constructor]
        fn constructor(name_: felt, symbol_: felt, max_supply_: u128, max_date_: u64, whitelited_collection_:ContractAddress) {
